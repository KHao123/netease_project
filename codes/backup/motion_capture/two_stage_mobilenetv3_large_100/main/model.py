...
from nets.module import Pose2Feat, ParamRegressor, Pose2Feat_small
...
class Model(nn.Module):
    def __init__(self, pose_net, pose2feat, mesh_net, param_regressor):
    ...
    def forward(self, inputs, targets=None, meta_info=None, mode='test'):
        ...
        with cm:
            ...
            # meshnet forward
            mesh_coord_img = self.mesh_net(shared_img_feat)
...
def get_model_small(vertex_num, joint_num, mode):
    ...
    model = Model(pose_net, pose2feat, mesh_net, param_regressor)
    return model
