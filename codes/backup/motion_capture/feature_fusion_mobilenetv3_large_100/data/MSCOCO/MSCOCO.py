...
class MSCOCO(torch.utils.data.Dataset):
    def __init__(self, transform, data_split):
        ...
        self.img_path = osp.join('/home/chenkanghao/mywork/pose_estimate/datasets', 'MSCOCO', 'images')
        self.annot_path = osp.join('/home/chenkanghao/mywork/pose_estimate/datasets', 'MSCOCO', 'annotations')
        self.rootnet_output_path = osp.join('/home/chenkanghao/mywork/pose_estimate/datasets', 'MSCOCO', 'rootnet_output', 'bbox_root_coco_output.json')
        ...
        self.coco_joint_regressor = np.load(osp.join('/home/chenkanghao/mywork/pose_estimate/datasets', 'MSCOCO', 'J_regressor_coco_hip_smpl.npy'))
