...
class FlowComposition(torch.nn.Module):
    ...
    def make_uv_img(self, src_img, src_info):
        ...
        return merge_uv, src_warp_to_uv, vis_warp_to_uv
    ...
    def process_source(self, src_img, src_info, primary_ids=None):
        ...
        morph_uv_img, uv_imgs, uv_vis_map = self.make_uv_img(morph_src_img.view(bs, ns, 3, h, w), src_info)    # (bs, 3, h, w)
        ...
        return morph_uv_img, input_G_bg, input_G_src, uv_imgs, uv_vis_map
    ...
    def forward(self, src_img, ref_img, src_smpl, ref_smpl, src_mask=None, ref_mask=None,
        ...
        uv_img, input_G_bg, input_G_src, uv_maps, uv_vis_maps = self.process_source(src_img, src_info, primary_ids=primary_ids)
        ...
        return input_G_bg, input_G_src, input_G_tsf, Tst, Ttt, uv_img, src_info, ref_info, uv_maps, uv_vis_maps
