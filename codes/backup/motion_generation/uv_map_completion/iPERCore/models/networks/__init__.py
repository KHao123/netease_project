...
class NetworksFactory(object):
    ...
    def get_by_name(network_name, *args, **kwargs):
        ...
        elif network_name == "uv_map_completion":
            from .generators.attlwb_spade_resunet import uv_map_completion
            network = uv_map_completion()

        # elif network_name == "uv_map_discriminator":
        #     from .discriminators import uv_map_discriminator
        #     network = uv_map_discriminator(*args, **kwargs)
