...
class FlowCompositionForTrainer(FlowComposition):
    ...
    def forward(self, src_img, ref_img, src_smpl, ref_smpl, src_mask=None, ref_mask=None,
        ...
        input_G_bg, input_G_src, input_G_tsf, Tst, Ttt, uv_img, src_info, ref_info, uv_maps, uv_vis_maps = super().forward(
        ...
        return input_G_bg, input_G_src, input_G_tsf, Tst, Ttt, src_mask, tsf_mask, head_bbox, body_bbox, uv_img, uv_maps, uv_vis_maps
